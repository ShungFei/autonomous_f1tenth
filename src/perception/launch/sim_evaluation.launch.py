        ...
        *spawn_model_from_xacro(
        ...
        Node(
            ...
            arguments=[
                ...
                f"/model/{opponent_name}/odometry@nav_msgs/msg/Odometry@gz.msgs.Odometry",
                f"/model/{name}/odometry_with_covariance@nav_msgs/msg/Odometry@gz.msgs.OdometryWithCovariance",
                f"/model/{opponent_name}/odometry_with_covariance@nav_msgs/msg/Odometry@gz.msgs.OdometryWithCovariance",
            ...
            remappings=[
                ...
                (f"/model/{opponent_name}/odometry", f"/{opponent_name}/odometry"),
                (
                    f"/model/{name}/odometry_with_covariance",
                    f"/{name}/odometry_with_covariance",
                ),
                (
                    f"/model/{opponent_name}/odometry_with_covariance",
                    f"/{opponent_name}/odometry_with_covariance",
                ),
